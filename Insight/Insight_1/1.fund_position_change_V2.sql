...
-- Counting number of funds

SELECT count(c.factset_fund_id)
  FROM [ent_v1].[ent_entity_structure] a
  --join [own_v5].[own_fund_detail] b on a.factset_entity_id = b.factset_fund_id
  join [own_v5].[own_ent_funds] c on a.factset_entity_id = c.factset_fund_id
  where a.[factset_parent_entity_id] = '08D3XB-E' --'002HJD-E'
  --where factset_entity_id = '04BCZ9-E'



--Using Ultimate Parent Entity
